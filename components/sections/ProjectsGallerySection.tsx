            ...
            <div className="container mx-auto px-4 relative z-10">
                <div className="text-center">
                    <button
                        ...
                        className="px-12 py-5 bg-green-500 hover:bg-[#222222] text-white font-black text-lg uppercase rounded-sm shadow-2xl transition-all hover:-translate-y-1 relative overflow-hidden group inline-block cursor-pointer"
                    >
                        <div className="absolute inset-0 w-full h-full bg-gradient-to-r from-transparent via-white/10 to-transparent -translate-x-full group-hover:animate-[shimmer_1.5s_infinite]"></div>
                        <span className="relative z-10">Quero Economizar</span>
                    </button>
                    <p className="text-xs text-white mt-3 font-bold uppercase tracking-wider">Fale com um especialista</p>
                </div>
            </div>
