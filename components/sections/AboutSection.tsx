            ...
            <div className="container mx-auto px-4 max-w-6xl">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    >
                        ...
                        <p className="text-base text-slate-600 leading-relaxed pb-4">
                        ...
                        <button className="px-8 py-4 bg-[#333333] hover:bg-[#444444] text-white font-bold uppercase rounded-sm shadow-xl transition-all border-b-4 border-[#1a1a1a] hover:-translate-y-1">
                            Quero Economizar
                        </button>
                    ...
                    >
                        <div className="aspect-square md:aspect-[3/4] bg-slate-900 rounded-sm overflow-hidden flex flex-col items-center justify-center p-8 text-center border-b-8 border-[#D51119] shadow-2xl relative">
                            ...
                            <div className="relative z-10 w-full flex flex-col items-center">
                                ...
                                />
                                <div className="w-16 h-16 bg-white/10 rounded-full mx-auto flex items-center justify-center backdrop-blur-sm border border-white/20 animate-pulse">
                                    <div className="w-0 h-0 border-l-[12px] border-l-white border-y-[8px] border-y-transparent ml-1"></div>
                                </div>
                                <p className="text-white mt-4 font-medium text-sm">Assista ao vídeo</p>
                            </div>
                        </div>
                    </motion.div>
